...
int main(int argc, FAR char *argv[])
{
    ...
    extern void usbd_cdcacm_init(uint8_t busid, uint8_t id, const char *path, uint8_t outep, uint8_t inep);
    extern void usbd_msc_init(uint8_t busid, char *path, uint8_t outep, uint8_t inep);

    usbd_cdcacm_init(0, 0, "/dev/ttyACM0", CDC_OUT_EP, CDC_IN_EP);
    usbd_msc_init(0, "/dev/ram1", MSC_OUT_EP, MSC_IN_EP);
    usbd_initialize(0, CONFIG_HPM_USBH_BASE, usbd_event_handler);
